...
<head>
  ...
  <style>
    ...
    /* Make card body link fill available space for flex */
    .card-body a {
      color: inherit;
          ...
          <div class="col-md-4 mb-4">
            <div class="card store-card h-100 d-flex flex-column">
              ...
              <div class="card-footer bg-transparent border-0">
                <form method="POST" onsubmit="return confirm('Are you sure you want to delete this store?');" class="m-0 text-end">
